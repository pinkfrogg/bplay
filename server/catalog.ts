export type CatalogAlbumRow = { id: number; title: string; coverImage: string; vinylImage: string | null; releaseYear?: number | null; trackFormat?: string | null; sortOrder: number };
